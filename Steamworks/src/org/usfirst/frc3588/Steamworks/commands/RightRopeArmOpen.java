 ...
 *
 */
public class RightRopeArmOpen extends Command {
	...
	protected void execute() {
		...
		//if (rightCount < RIGHT_OPEN_POSITION) {
			//RobotMap.climbingRightSweeper.set(RIGHT_DEPLOY);
		//}
		if (rightCount >= R_LOW_END) {
			done = true;
		} 
		else if (rightCount > R_HIGH_END) {
