 ...
 *
 */
public class LeftRopeArmOpen extends Command {
...
//	private static final double RIGHT_DEPLOY = 0.5;
    ...
    protected void execute() {
		...
		if (leftCount < LEFT_OPEN_POSITION) {
			RobotMap.climbingLeftSweeper.set(LEFT_DEPLOY);
		} else if (leftCount >= L_LOW_END) {
			done = true;
		} else if (leftCount > L_HIGH_END) {
