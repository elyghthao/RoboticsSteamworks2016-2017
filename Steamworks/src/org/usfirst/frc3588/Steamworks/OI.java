...
public class OI {
    ...
    public JoystickButton flapperArmCose2;
	...
	public OI() {
        ...
        flapperArmCose2 = new JoystickButton(joystick2, 12);
        flapperArmCose2.whileHeld(new ArmsClose());
        ...
        flapperArmClose1 = new JoystickButton(joystick1, 12);
        ...
        SmartDashboard.putData("Delay Command", new DelayCommand());
