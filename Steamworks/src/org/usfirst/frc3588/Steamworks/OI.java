...
public class OI {
    ...
    public JoystickButton switchButton1;
    public JoystickButton ropeArmOpen1;
    public JoystickButton ropeArmClose1;
    public Joystick joystick1;
    public JoystickButton gearRelease2;
    public JoystickButton climbStart2;
    public JoystickButton gearClose2;
    public JoystickButton switchButton2;
    public JoystickButton ropeArmOpen2;
    public JoystickButton ropeArmClose2;
	...
	public OI() {
        ...
        ropeArmClose2 = new JoystickButton(joystick2, 11);
        ropeArmClose2.whenPressed(new RopeArmClose());
        ropeArmOpen2 = new JoystickButton(joystick2, 7);
        ropeArmOpen2.whenReleased(new RopeArmOpen());
        switchButton2 = new JoystickButton(joystick2, 1);
        switchButton2.whenPressed(new directionSwitch());
        ...
        ropeArmClose1 = new JoystickButton(joystick1, 11);
        ropeArmClose1.whenPressed(new RopeArmClose());
        ropeArmOpen1 = new JoystickButton(joystick1, 7);
        ropeArmOpen1.whenReleased(new RopeArmOpen());
        switchButton1 = new JoystickButton(joystick1, 7);
        switchButton1.whenPressed(new directionSwitch());
        ...
        SmartDashboard.putData("directionSwitch", new directionSwitch());
        SmartDashboard.putData("RopeArmOpen", new RopeArmOpen());
        SmartDashboard.putData("Reverse Climbing Command", new ReverseClimbingCommand());
        SmartDashboard.putData("RopeArmClose", new RopeArmClose());
