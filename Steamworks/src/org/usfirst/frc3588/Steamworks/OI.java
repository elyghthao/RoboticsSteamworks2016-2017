...
public class OI {
    ...
    public JoystickButton climbStart;
    public Joystick joystick;
    
    private ClimbingCommand climbingCommand = new ClimbingCommand();

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public ClimbingCommand getClimbingCommand() {
		return climbingCommand;
	}
	...
	public OI() {
        ...
        climbStart = new JoystickButton(joystick, 1);
        climbStart.whileHeld(climbingCommand);
        gearRelease = new JoystickButton(joystick, 2);
        gearRelease.whileHeld(new GearReleaseCommand());
