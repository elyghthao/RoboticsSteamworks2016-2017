...
public class OI {
	...
	public OI() {
        ...
        ropeArmOpen2 = new JoystickButton(joystick2, 12);
        ropeArmOpen2.whenReleased(new RopeArmOpen());
        ropeArmclose2 = new JoystickButton(joystick2, 12);
        ropeArmclose2.whileHeld(new RopeArmClose());
        ...
        ropeArmOpen1 = new JoystickButton(joystick1, 12);
        ropeArmOpen1.whenReleased(new RopeArmOpen());
        ropeArmclose1 = new JoystickButton(joystick1, 12);
        ropeArmclose1.whileHeld(new RopeArmClose());
