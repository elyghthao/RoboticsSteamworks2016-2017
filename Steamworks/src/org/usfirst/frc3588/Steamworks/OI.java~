...
public class OI {
	...
	public JoystickButton reverseClimbing2;
	private JoystickButton reverseClimbing1;
	...
	public OI() {
        ...
        reverseClimbing2 =  new JoystickButton(joystick2, 3);
        reverseClimbing2.whenPressed (new ReverseClimbingCommand());
        ...
        reverseClimbing1 =  new JoystickButton(joystick1, 3);
        reverseClimbing1.whenPressed (new ReverseClimbingCommand());
